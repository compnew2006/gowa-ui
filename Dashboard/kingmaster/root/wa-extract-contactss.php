...
$page_title = "استخراج متصلين الواتساب | Kingmaster";
      ...
      <table style="width:100%; border-collapse:collapse;">
        <thead>
          <tr style="background:#0f172a;">
            ...
            <th style="padding:10px; border-bottom:1px solid var(--border-color); text-align:right;">Pushname</th>
          </tr>
        </thead>
...
document.addEventListener('DOMContentLoaded', function() {
    loadAccounts();
    loadIntervals();
    loadCampaigns('Extract Contacts WA');
    loadContent();
});
...
function saveCampaign(id) {
     ...
     window.location.href = "api/save_data.php?camp_id=" + id+"&tool=wa-extract-contacts";
}
...
function loadContacts() {
  ...
  fetch('api/wa_contacts.php?' + params.toString())
    .then(r=>r.json())
    .then(j=>{
