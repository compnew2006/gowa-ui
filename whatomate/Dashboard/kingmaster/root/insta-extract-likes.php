...
$page_title = "استخراج الاعجابات | Kingmaster";
      ...
      <table style="width:100%; border-collapse:collapse;">
       <thead>
          <tr style="background:#0f172a;">
            ...
            <th style="padding:10px; border-bottom:1px solid var(--border-color); text-align:right;">اسم المستخدم</th>
            <th style="padding:10px; border-bottom:1px solid var(--border-color); text-align:right;">المعرف</th>
            <th style="padding:10px; border-bottom:1px solid var(--border-color); text-align:right;">الاسم بالكامل</th>
            </tr>
        </thead>
...
document.addEventListener('DOMContentLoaded', function() {
    loadAccounts();
    loadIntervals();
    loadCampaigns('Extract Likes IG');
    loadContent();
});
...
function saveCampaign(id) {
     ...
     window.location.href = "api/save_data.php?camp_id=" + id+"&tool=Extract Likes IG";
}
