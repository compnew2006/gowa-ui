...
import (
	...
	"github.com/shridarpatil/gowa-ui/internal/frontend"
	...
	"github.com/shridarpatil/gowa-ui/internal/worker"
...
func runWorker(args []string) {
	...
	lo := logf.New(logf.Opts{
		...
		EnableCaller:    true,
		TimestampFormat: "2006-01-02 15:04:05",
		DefaultFields:   []any{"app", "gowa-ui-worker"},
	})
