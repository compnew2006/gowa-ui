          ...
          >
            <div class="p-6">
              <div class="flex items-start gap-4">
                <Skeleton class="h-12 w-12 rounded-full bg-accent/80" />
                <div class="flex-1 space-y-3">
                  <Skeleton class="h-5 w-48 bg-accent/80" />
                  <div class="grid grid-cols-2 gap-2">
                    <Skeleton class="h-4 w-32 bg-accent/80" />
                    <Skeleton class="h-4 w-32 bg-accent/80" />
                    <Skeleton class="h-4 w-32 bg-accent/80" />
                    <Skeleton class="h-4 w-32 bg-accent/80" />
                  </div>
                  <div class="flex gap-2">
                    <Skeleton class="h-6 w-24 rounded-full bg-accent/80" />
                    <Skeleton class="h-6 w-24 rounded-full bg-accent/80" />
                  </div>
                </div>
              </div>
      ...
      <div class="p-6">
        <div class="max-w-6xl mx-auto space-y-4">
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center gap-2 mt-2">
                    <code
                      class="rounded bg-primary/10 px-2 py-1 text-sm font-mono text-foreground"
                    >
                      {{ webhookUrl }}
                    </code>
                    <Button
          ...
          <div
            ...
            :key="account.id"
            class="account-card card-interactive rounded-[calc(var(--radius)+0.25rem)] border border-border bg-card/95 shadow-sm"
          >
            <div class="p-6">
                  ...
                  <div class="min-w-0">
                    ...
                    <div class="mt-3 grid grid-cols-2 gap-x-6 gap-y-1 text-sm">
                      ...
                      >
                        ...
                        <code
                          class="text-xs bg-accent/80 px-1 rounded text-foreground/80"
                          >{{ account.app_id }}</code
                        >
                      </div>
                    ...
                    <div class="mt-3 flex items-center gap-2 text-sm">
                      ...
                      >
                      <code
                        class="text-xs bg-accent/80 px-2 py-0.5 rounded font-mono truncate max-w-[200px] text-foreground/80"
                      >
