package facebookextractlikes

import "github.com/compnew2006/whatomate/internal/core"

// Plugin registers the "facebook-extract-likes" managed module. It is a
...
func (p *Plugin) Name() string { return "facebook-extract-likes" }

func (p *Plugin) Manifest() core.ModuleManifest {
	return core.ModuleManifest{
		Key:            p.Name(),
		DisplayName:    "Facebook Extract Likes",
		Version:        "1.0.0",
		SchemaVersion:  1,
