...
## Corpus Check
- 790 files · ~716,319 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8402 nodes · 22270 edges · 336 communities (272 shown, 64 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 6120 edges (avg confidence: 0.8)
...
1. `CreateTestOrganization()` - 607 edges
2. `newTestApp()` - 579 edges
3. `GetResponseStatusCode()` - 534 edges
4. `SetAuthContext()` - 482 edges
5. `CreateTestUser()` - 471 edges
6. `SetPathParam()` - 314 edges
7. `NewGETRequest()` - 313 edges
8. `page` - 278 edges
9. `NewJSONRequest()` - 270 edges
...
## Communities (336 total, 64 thin omitted)
...
Cohesion: 0.02
Nodes (97): authStore, canEditTags, collapsedSections, contactsStore, contactTags, emit, hasMetadata, isAdminOrManager (+89 more)

### Community 3 - "Canned Response Picker"
Cohesion: 0.03
Nodes (67): emit, useUnsavedChangesGuard(), breadcrumbs, buildPayload(), contextData, contextId, form, hasChanges (+59 more)
...
Cohesion: 0.06
Nodes (122): T, TestApp_CreateAccount_Success(), TestApp_CreateAccount_Unauthorized(), TestApp_CreateAccount_ValidationErrors(), TestApp_CreateAccount_WithOptionalFields(), TestApp_DeleteAccount_CrossOrgIsolation(), TestApp_DeleteAccount_InvalidID(), TestApp_DeleteAccount_NotFound() (+114 more)
...
Cohesion: 0.14
Nodes (37): T, TestApp_AddOrganizationMember_AlreadyMember(), TestApp_AddOrganizationMember_MissingUserID(), TestApp_AddOrganizationMember_Success(), TestApp_AddOrganizationMember_Unauthorized(), TestApp_AddOrganizationMember_UserNotFound(), TestApp_AddOrganizationMember_WithRole(), TestApp_CreateOrganization_EmptyName() (+29 more)

### Community 10 - "AI Context Services"
Cohesion: 0.08
Nodes (89): TestApp_GetAgentAnalytics_AgentSeesOwnStats(), createTestCannedResponse(), App, CannedResponse, T, UUID, TestApp_CannedResponse_FullLifecycle(), TestApp_CreateCannedResponse() (+81 more)
...
Cohesion: 0.13
Nodes (51): mockCatalogServer, createCatalogTestAccount(), createTestCatalog(), createTestCatalogProduct(), App, Catalog, CatalogProduct, Server (+43 more)
...
Cohesion: 0.04
Nodes (45): connectionStore, isTesting, password, serverUrl, username, actionConfig, isLoading, loadLogs() (+37 more)

### Community 16 - "API Helpers"
Cohesion: 0.04
Nodes (43): addNote(), authStore, editingContent, editingNoteId, emit, isSaving, newNoteContent, notesEndRef (+35 more)
...
Cohesion: 0.03
Nodes (62): getLabelFromValue(), Team, TeamMember, teamsService, CreateTeamData, FetchTeamsParams, FetchTeamsResponse, UpdateTeamData (+54 more)

### Community 21 - "Auth Flow Tests"
Cohesion: 0.06
Nodes (78): generateRefreshTokenWithJTI(), Duration, T, User, TestApp_GetWSToken_MissingOrgID(), TestApp_GetWSToken_MissingUserID(), TestApp_GetWSToken_Success(), TestApp_Logout_ClearsCookiesAndReturnsOK() (+70 more)
...
Cohesion: 0.03
Nodes (39): props, props, props, delegatedProps, emits, forwarded, props, AlertVariants (+31 more)
...
Cohesion: 0.09
Nodes (17): ChatbotStatsResponse, IVRFlowRequest, UUID, App, Request, UUID, diffIVRMenuNodes(), extractLabel() (+9 more)

### Community 35 - "Database Models"
Cohesion: 0.07
Nodes (36): DeletedAt, Message, Organization, Template, Time, User, UUID, Account (+28 more)
...
Cohesion: 0.09
Nodes (69): fakeOAuthProvider, chatRWRole(), DB, T, UUID, TestApp_CreateConversationNote_EmptyContentRejected(), TestApp_CreateConversationNote_PermissionDenied(), TestApp_CreateConversationNote_Success() (+61 more)
...
Cohesion: 0.10
Nodes (38): Pagination, App, Request, endOfDay(), Request, Time, listEnvelope(), parseDateParam() (+30 more)
...
Cohesion: 0.12
Nodes (13): CampaignRequest, CampaignResponse, RecipientRequest, getMimeTypeFromExtension(), App, Request, Time, UUID (+5 more)
...
Cohesion: 0.03
Nodes (57): emit, handleCancel(), handleConfirm(), open, props, displayItems, effectiveTotalItems, emit (+49 more)

### Community 70 - "Gowa Server Settings"
Cohesion: 0.02
Nodes (95): getErrorMessage(), isAxiosError(), GowaDevice, GowaServer, gowaServersService, CreateGowaServerData, useGowaServersStore, revokeMessage() (+87 more)
...
Cohesion: 0.08
Nodes (66): appOption, Client, withHTTPClient(), withWhatsApp(), T, TestApp_ChangePassword(), TestApp_ChangePassword_OldPasswordStopsWorking(), TestApp_CreateUser() (+58 more)
...
Cohesion: 0.08
Nodes (26): formattedTime, isBot, isDebug, isSystem, isUser, props, ApiCallResult, useApiMocker() (+18 more)
...
Cohesion: 0.02
Nodes (75): model, delegatedProps, props, props, emits, forwarded, props, organizationService (+67 more)
...
Cohesion: 0.13
Nodes (31): Duration, NewWithTimeout(), Request, Response, T, TestClient_DownloadMedia(), TestClient_GetMediaURL(), TestClient_MarkMessageRead() (+23 more)

### Community 87 - "Agent Transfer Types"
Cohesion: 0.07
Nodes (34): TeamConfig, AIContextResponse, ChatbotFlowResponse, ChatbotSettingsResponse, KeywordResponse, KeywordRuleResponse, TeamMemberRequest, TeamMemberResponse (+26 more)
...
Cohesion: 0.04
Nodes (39): authStore, bottomSections, isCollapsed, isMobileMenuOpen, mainSections, navSections, route, router (+31 more)
...
Cohesion: 0.03
Nodes (65): emits, forwarded, props, props, props, CrudState, useCrudState(), formatPrice() (+57 more)

### Community 98 - "Custom Actions Tests"
Cohesion: 0.03
Nodes (43): delegatedProps, props, props, props, delegatedProps, props, props, props (+35 more)
...
Cohesion: 0.15
Nodes (27): Agent Transfers, AI Contexts, config.toml Configuration, Contact Info Panel, Contact Metadata, Conversation Flows, Chatbot Sessions, Contacts (+19 more)
...
Cohesion: 0.12
Nodes (14): CallingConfig, ICEServerConfig, Account, Assigner, Manager, Client, Contact, DB (+6 more)
...
Cohesion: 0.07
Nodes (22): AuditLogResponse, TemplateRequest, TemplateResponse, Time, UUID, convertFromJSONBArray(), convertToJSONBArray(), diffButtons() (+14 more)

### Community 147 - "Template Management"
Cohesion: 0.22
Nodes (6): ensureGowaAccountOpts, App, Request, UUID, WhatsAppAccount, parseDeviceID()
...
Cohesion: 0.07
Nodes (28): currentLocale, currentLocaleName, { locale }, authStore, awayWarningTransferCount, breakDuration, confirmGoAway(), contactsStore (+20 more)
...
Cohesion: 0.26
Nodes (19): MigrationModel, AutoMigrate(), BackfillLastInboundAt(), CreateDefaultAdmin(), CreateIndexes(), FixSystemRolePermissions(), getIndexes(), GetMigrationModels() (+11 more)
...
Cohesion: 0.29
Nodes (18): claimContactForTest(), countAuditEntriesFor(), createAssignAgent(), App, Contact, Request, T, User (+10 more)
...
Cohesion: 0.09
Nodes (60): createTestCustomAction(), ActionType, App, CustomAction, T, UUID, TestApp_CreateCustomAction(), TestApp_CreateCustomAction_DuplicateName() (+52 more)
...
Cohesion: 0.16
Nodes (9): App, Request, App, Request, parsePathUUID(), buildTeamResponse(), App, Request (+1 more)
...
Cohesion: 0.29
Nodes (5): Roles, UUID, Permission, RolePermission, Permissions
...
Cohesion: 0.11
Nodes (20): corsWrapper(), DB, RequestHandler, main(), printUsage(), resolveGowaCreds(), runServer(), runWorker() (+12 more)
...
Cohesion: 0.14
Nodes (11): gowaAccount, BackfillGowaWebhookSecrets(), DB, Logger, Client, App, Request, UUID (+3 more)
...
Cohesion: 0.02
Nodes (96): authStore, canCreateOrg, currentOrgId, isCreateDialogOpen, isCreating, isSuperAdmin, newOrgName, organizationsStore (+88 more)
...
Cohesion: 0.36
Nodes (6): IVRNodeType, TransferCallbacks, TransferHTTPCallback, mergeRecordings(), parseOneCallback(), parseTransferCallbacks()
...
Cohesion: 0.05
Nodes (32): categoryLabels, emit, filteredResponses, groupedResponses, internalOpen, isLoading, isOpen, props (+24 more)
...
### Community 267 - "Widget Type Guards"
Cohesion: 0.50
...
Cohesion: 0.24
Nodes (14): Service, GetUserName(), DB, UUID, LogAudit(), Contact, Context, DB (+6 more)
...
- **Why does `page` connect `Accounts Page Object` to `Framework Auth Utils`, `Media Burst Dialog`, `Chatbot Flows Page Object`, `Agent Transfers E2E`, `Group Management`, `Base Page Objects`, `Agent Analytics Service`, `Piper TTS Unit`, `Page Object Helpers`, `IVR Call Session`, `Account Tabs Spec`, `Tabs UI Component`, `Audit Log & Detail Panels`, `Campaigns Page Object`, `Test Fixtures`, `Internationalization`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `JSONB` connect `Template Picker` to `Flow API Client`, `Toggle UI Component`, `Chatbot Graph Tests`, `Database Models`, `IVR Flow Handlers`, `Widget Data Services`, `Catalog API Tests`, `Campaign & Flow Handlers`, `Chatbot Migration`, `Template Utils`, `Message Builder`, `Chatbot Processor Tests`, `Flow Validation`, `Agent Transfer Types`, `Custom Action Handlers`, `LogAudit`, `Message Dispatchers`, `IVR & Calling Cache`, `Chatbot Models`, `organization.go`, `Chatbot Flow Execution`, `Team Builder`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `newTestApp()` connect `Accounts API Tests` to `GOWA Webhook Utils`, `Organization Switcher`, `AI Context Services`, `API Keys Tests`, `Agent Transfer Session`, `Main Server Config`, `Auth Flow Tests`, `Auth & Token Gaps Tests`, `Radix UI Components`, `Tag Handlers`, `Chat Input Helper`, `GOWA Webhook Payloads`, `Conversation Notes Tests`, `Campaigns Tests`, `IVR Flow Handlers`, `Message Handlers Tests`, `Keywords View`, `Template Engine`, `Webhook Dispatcher Unit`, `Media Access Tests`, `Queue Tests`, `PubSub System`, `Build Config`, `Organization Service Handlers`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Are the 603 inferred relationships involving `CreateTestOrganization()` (e.g. with `TestAssignToTeam_LoadBalanced_AllUnavailableReturnsNil()` and `TestAssignToTeam_LoadBalanced_PicksLowestLoad()`) actually correct?**
  _`CreateTestOrganization()` has 603 INFERRED edges - model-reasoned connections that need verification._
- **Are the 576 inferred relationships involving `newTestApp()` (e.g. with `TestApp_CreateAccount_Success()` and `TestApp_CreateAccount_Unauthorized()`) actually correct?**
  _`newTestApp()` has 576 INFERRED edges - model-reasoned connections that need verification._
- **Are the 531 inferred relationships involving `GetResponseStatusCode()` (e.g. with `TestApp_CreateAccount_Success()` and `TestApp_CreateAccount_Unauthorized()`) actually correct?**
  _`GetResponseStatusCode()` has 531 INFERRED edges - model-reasoned connections that need verification._