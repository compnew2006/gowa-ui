...
$page_title = "اعضاء المجموعة | Kingmaster";
    ...
    <div class="modal-content">
        ...
        <form id="campaignForm">
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="form-label">
                    <i class="fas fa-tag"></i> معرف المجموعه 
                </label>
                <input type="text" class="form-input" id="keyword" placeholder="ادخل المعرف المجموعه" required>
            </div>
    ...
    grid.innerHTML = campaigns.map(campaign => `
        <div class="campaign-card">
            ...
            <div class="campaign-info">
                ...
                <div class="campaign-info-item">
                    <span class="campaign-info-label"><i class="fa-brands fa-facebook fa-beat" style="--fa-animation-duration: 2s; color: #c8cae7;"></i> المنصة:</span>
