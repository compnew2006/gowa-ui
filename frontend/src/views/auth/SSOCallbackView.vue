      ...
      <CardHeader class="text-center">
        <div class="flex justify-center mb-4">
          ...
          <div
            ...
            class="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-500/12"
          >
            <CheckCircle class="h-7 w-7 text-emerald-500" />
          </div>
          <div
            v-else
            class="flex h-12 w-12 items-center justify-center rounded-full bg-destructive/12"
          >
