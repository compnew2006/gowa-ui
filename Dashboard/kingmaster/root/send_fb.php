...
$page_title = "اعادة استهداف | Kingmaster";
        ...
        <form id="campaignForm">
            ...
            <div class="form-group">
                ...
                <div class="option-cards" id="msgTypeCards">
                  ...
                  <div class="option-card" data-value="poll"><i class="fas fa-square-poll-horizontal"></i><div><div class="option-title">زر</div><div class="option-desc">سؤال بخيارات</div></div></div>
...
function loadAccounts() {
    fetch('api/get_page_accounts.php')
    .then(res => res.json())
    .then(data => {
        if (data.success) {
  ...
  for (let i = 0; i < choices.length; i += 2) {
    ...
    html += `
      <input
        class="form-input"
        placeholder="الرابط"
        value="${escapeHtml(choices[i + 1] || '')}"
        oninput="pbState.choices[${i + 1}] = this.value"
      />
    `;
