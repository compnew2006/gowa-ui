...
$page_title = "استخراج رسالة واتساب | Kingmaster";
...
document.addEventListener('DOMContentLoaded', function() {
    loadAccounts();
    loadIntervals();
    loadCampaigns('Extract Messages WA');
    loadContent();
});
...
function saveCampaign(id) {
     ...
     window.location.href = "api/save_data.php?camp_id=" + id+"&tool=Extract-Messages-WA";
}
...
function loadContacts() {
  ...
  fetch('api/wa_msg.php?' + params.toString())
    .then(r=>r.json())
    .then(j=>{
