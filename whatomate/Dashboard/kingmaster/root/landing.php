...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="nav-container">
            ...
            <button class="nav-toggle" id="navToggle" type="button" aria-label="القائمة" aria-expanded="false">
    ...
    <script src="assets/js/landing.js?v=1"></script>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  wa.href = "https://wa.me/201033685371";
  wa.target = "_blank";
  ...
  wa.style.zIndex = "999999999";
  wa.style.boxShadow = "0 4px 12px rgba(0,0,0,.3)";
  wa.style.cursor = "pointer";

  wa.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="30" height="30">
      <path fill="#fff" d="M16 3C9.37 3 4 8.37 4 15c0 2.65.87 5.1 2.35 7.08L4 29l7.2-2.28A12 12 0 1 0 16 3z"/>
    </svg>
  `;
