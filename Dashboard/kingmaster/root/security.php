...
<head>
  ...
  <style>
    ...
    .card { background: var(--glass-bg); border:1px solid var(--glass-border); border-radius: 16px; backdrop-filter: blur(14px); box-shadow: 0 8px 28px rgba(0,0,0,.35); margin-bottom: 1rem; }
    .card-body { padding: 1.25rem; }
    h2 { font-size:1.25rem; color:#fff; margin:0 0 .75rem; display:flex; align-items:center; gap:.5rem; }
    h3 { font-size:1.05rem; color:#e5e7eb; margin:.75rem 0 .5rem; }
...
<body class="rtl ar">
  ...
  <div class="container">
    <div class="header-bar">
      <h1 class="header-title"><i class="fas fa-lock"></i> الأمان</h1>
      <a class="back-link" href="landing"><i class="fas fa-arrow-right"></i><span>رجوع</span></a>
    </div>

    <div class="card"><div class="card-body">
      <h2>ممارسات الأمان</h2>
      <ul>
        <li>تشفير الاتصالات حيثما أمكن.</li>
        <li>ضوابط وصول مبنية على مبدأ أقل الصلاحيات.</li>
        <li>مراجعات دورية للتحديثات الأمنية.</li>
      </ul>
      <h2>استجابة الحوادث</h2>
      <p>نقوم بتقييم ومعالجة أي حادث أمني بشكل سريع، وإخطار الأطراف المتأثرة وفق القوانين المعمول بها.</p>
      <h2>مسؤوليات المستخدم</h2>
      <ul>
        <li>حماية بيانات الدخول وعدم مشاركتها مع الغير.</li>
        <li>تحديث كلمة المرور بشكل دوري واستخدام كلمة مرور قوية.</li>
        <li>الإبلاغ عن أي نشاط مريب فورًا.</li>
      </ul>
      <p class="muted">للتواصل حول قضايا الأمان: استخدم نموذج "اتصل بنا".</p>
    </div></div>
  </div>
</body>
</html>
