...
func TestUpdateMessageStatus_DeliveredUpdatesRecipient(t *testing.T) {
	...
	org, msg, campaign, recipient := webhookTestData(t, app, models.MessageStatusSent)

	app.updateMessageStatus(org.ID, msg.WhatsAppMessageID, "delivered", nil)
...
func TestUpdateMessageStatus_ReadUpdatesRecipient(t *testing.T) {
	app := webhookTestApp(t)
	org, msg, campaign, recipient := webhookTestData(t, app, models.MessageStatusDelivered)

	app.updateMessageStatus(org.ID, msg.WhatsAppMessageID, "read", nil)
...
func TestUpdateMessageStatus_NonCampaignMessageIgnoresRecipient(t *testing.T) {
	...
	app.updateMessageStatus(org.ID, waMsgID, "delivered", nil)
...
func TestUpdateMessageStatus_StatusPriorityRespected(t *testing.T) {
	app := webhookTestApp(t)
	org, msg, _, recipient := webhookTestData(t, app, models.MessageStatusRead)
...
func TestUpdateMessageStatus_FailedUpdatesMessage(t *testing.T) {
	...
	app.updateMessageStatus(org.ID, msg.WhatsAppMessageID, "failed", errors)
...
func TestUpdateMessageStatus_FailedBroadcastsErrorMessageViaWebSocket(t *testing.T) {
	...
	app.updateMessageStatus(org.ID, waMsgID, "failed", errors)
