...
A complete commented example lives in [`config.example.toml`](https://github.com/shridarpatil/Gowa-UI/blob/main/config.example.toml) at the repository root — copy it to `config.toml` and edit. The reference below documents every section.
