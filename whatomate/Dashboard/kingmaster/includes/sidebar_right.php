...
<aside class="right-sidebar" id="rightSidebar" aria-label="قائمة الإدارة">
  ...
  <ul class="sidebar-menu">
    ...
    <li><a href="products.php" class="<?php echo ($current_page == 'products.php') ? 'active' : ''; ?>"><i class="fa-brands fa-product-hunt fa-beat-fade" style="color: #5abb25;"></i>المنتجات</a></li>
