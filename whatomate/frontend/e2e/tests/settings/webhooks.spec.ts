...
test.describe('Webhooks Management', () => {
  ...
  test('should display webhooks list', async () => {
    await expect(tablePage.tableBody).toBeVisible()
  })

  test('should open create webhook dialog', async () => {
  ...
  test('should show validation error when no events selected', async () => {
    await tablePage.clickAddButton()
    await dialogPage.waitForOpen()
  ...
  test('should edit existing webhook', async () => {
  ...
  test('should toggle webhook events', async () => {
    const webhook = createWebhookFixture()
  ...
  test('should cancel webhook creation', async () => {
