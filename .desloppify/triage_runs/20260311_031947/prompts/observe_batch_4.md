...
Dimensions assigned to you: design_coherence, authorization_consistency, mid_level_elegance, high_level_elegance
...
- [review::] (authorization_consistency) **review::.::holistic::authorization_consistency::inconsistent-auth-checks**

- [review::] (authorization_consistency) **review::.::holistic::authorization_consistency::missing-resource-level-auth**

- [review::] (authorization_consistency) **review::.::holistic::authorization_consistency::super-admin-org-switch**

- [review::] (design_coherence) **review::.::holistic::design_coherence::cache-module-fragmentation**

- [review::] (design_coherence) **review::.::holistic::design_coherence::contacts-messaging-responsibility-bleed**

- [review::] (design_coherence) **review::.::holistic::design_coherence::monster-functions**

- [review::] (design_coherence) **review::.::holistic::design_coherence::parameter-bag-anti-pattern**

- [review::] (high_level_elegance) **review::.::holistic::high_level_elegance::handlers_package_bloat**

- [review::] (high_level_elegance) **review::.::holistic::high_level_elegance::monolithic_handler_files**

- [review::] (mid_level_elegance) **review::.::holistic::mid_level_elegance::app_god_object**

- [review::] (mid_level_elegance) **review::.::holistic::mid_level_elegance::authorization_pattern_inconsistency**

- [review::] (mid_level_elegance) **review::.::holistic::mid_level_elegance::provider_abstraction_leak**
