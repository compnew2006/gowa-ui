...
import { localeDirectionManager } from './locale-direction'
...
// Apply initial document lang + direction on app startup.
localeDirectionManager.applyLocaleDirection(i18n.global.locale.value)
...
export function setLocale(locale: string) {
  ...
  localeDirectionManager.applyLocaleDirection(locale)
}
