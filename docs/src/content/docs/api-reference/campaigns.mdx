...
<Aside type="caution">
  Campaign endpoints require the `campaigns:read`, `campaigns:write`, or `campaigns:delete` permissions respectively. Starting, pausing, cancelling, and retrying campaigns requires `campaigns:execute`.
</Aside>
