...
func TestPluginRoutes(t *testing.T) {
	...
	require.Equal(t, "facebook-people-search", plugin.Name())
	require.Equal(t, core.ModuleManifest{
		Key: "facebook-people-search", DisplayName: "Facebook People Search", Version: "1.0.0",
	...
	routes := []struct {
		...
		{method: fasthttp.MethodGet, path: "/api/facebook/people-search/campaigns"},
		{method: fasthttp.MethodGet, path: "/api/facebook/people-search"},
		{method: fasthttp.MethodPost, path: "/api/facebook/people-search/add-contacts"},
	}
