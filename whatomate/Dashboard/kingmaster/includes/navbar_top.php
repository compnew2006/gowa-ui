...
<nav class="top-navbar" id="topNavbar">
  <div class="nav-content">
    ...
    <ul class="nav-links" id="topNavLinks">
      ...
      <li><a href="data-extraction.php" class="<?php echo ($current_page == 'data-extraction.php') ? 'active' : ''; ?>"><i class="fa-solid fa-database fa-beat-fade" style="color: #63E6BE;"></i>البيانات</a></li>
      <li><a href="sending-settings.php" class="<?php echo ($current_page == 'sending-settings.php') ? 'active' : ''; ?>"><i class="fas fa-cog fa-fade"></i> الإعدادات</a></li>
      <li><a href="points.php" class="<?php echo ($current_page == 'points.php') ? 'active' : ''; ?>"><i class="fa-solid fa-gem fa-beat-fade" style="color: #74C0FC;"></i>شحن</a></li>
...
<?php } elseif ($is_admin == "1") { ?>
    <li>
        <a href="statistics.php" class="<?= ($current_page == 'statistics.php') ? 'active' : ''; ?>">
            <i class="fa-solid fa-unlock fa-beat-fade" style="color: #2374b6ff;"></i>
            المسؤول
        </a>
    </li>
<?php } ?>
