...
const emit = defineEmits<{
  (e: 'select', payload: { id: string; content: string; attachments: CannedResponseAttachment[] }): void
  (e: 'close'): void
}>()
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-1.5">
                  <span v-if="response.attachments?.length" class="inline-flex items-center text-[11px] text-muted-foreground">
