...
<CardGrid>
  ...
  <Card title="Real-time Chat" icon="comment">
    Live messaging with rich message bubbles, previews, and clickable internet links.
  </Card>
...
<CardGrid>
  ...
  <Card title="Chat Workspace" icon="comment">
    Learn how chat bubbles, media, templates, and clickable links behave. [Open guide →](/whatomate/features/chat-workspace)
  </Card>
