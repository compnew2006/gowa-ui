...
func createCustomActionsAuthorizedUser(t *testing.T, app *handlers.App, orgID uuid.UUID) *models.User {
	t.Helper()

	role := testutil.CreateTestRoleWithKeys(t, app.DB, orgID, "custom-actions-manager", []string{
		"custom_actions:read",
...
func TestApp_ListCustomActions(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		user := createCustomActionsAuthorizedUser(t, app, org.ID)
...
func TestApp_UpdateCustomAction(t *testing.T) {
	...
	t.Run("CrossOrgIsolation", func(t *testing.T) {
		...
		user2 := createCustomActionsAuthorizedUser(t, app, org2.ID)
...
func TestApp_ListCustomActions_CrossOrgIsolation(t *testing.T) {
	...
	org1 := testutil.CreateTestOrganization(t, app.DB)
	org2 := testutil.CreateTestOrganization(t, app.DB)
	user1 := createCustomActionsAuthorizedUser(t, app, org1.ID)
	user2 := createCustomActionsAuthorizedUser(t, app, org2.ID)
...
func TestApp_ExecuteCustomAction(t *testing.T) {
	...
	t.Run("JavaScriptTimeout", func(t *testing.T) {
		t.Parallel()
		...
		action := createTestCustomAction(t, app, org.ID, "Slow JS", models.ActionTypeJavascript,
			map[string]interface{}{
				"code":       "while (true) {}",
				"timeout_ms": 100,
			}, true, 0)
		...
		assert.Equal(t, "Action execution failed", resp.Data.Message)
		assert.NotNil(t, resp.Data.Toast)
