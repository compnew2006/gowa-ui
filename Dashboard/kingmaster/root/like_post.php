...
$page_title = "اعجاب منشور | Kingmaster";
    ...
    <div class="modal-content">
        ...
        <form id="campaignForm">
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="form-label">
                    <i class="fas fa-tag"></i> معرف المنشور 
                </label>
                <input type="text" class="form-input" id="keyword" placeholder="ادخل المعرف للمنشور" required>
            </div>
