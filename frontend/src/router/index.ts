    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          redirect: "/closed-chats",
        },
        {
          path: "settings/whatsapp-filter",
          redirect: "/whatsapp-filter",
        },
        {
          path: "settings/tags",
          name: "tags",
...
const navigationOrder = [
  ...
  { path: "/campaigns", permission: "campaigns" },
  {
    ...
    childPaths: [
  { path: "/campaigns", permission: "campaigns" },
  { path: "/group-join-campaigns", permission: "campaigns" },
  { path: "/group-extraction", permission: "campaigns" },
  { path: "/member-extraction", permission: "campaigns" },
      { path: "/chatbot", permission: "settings.chatbot" },
      { path: "/chatbot/keywords", permission: "chatbot.keywords" },
      { path: "/chatbot/flows", permission: "flows.chatbot" },
      { path: "/chatbot/ai", permission: "chatbot.ai" },
      ...
      { path: "/canned-responses", permission: "canned_responses" },
      { path: "/saved-contents", permission: "saved_contents" },
      { path: "/closed-chats", permission: "chat" },
      { path: "/whatsapp-filter", permission: "wa_filter" },
      { path: "/group-search", permission: "campaigns" },
    ],
  },
  {
    path: "/facebook",
  ...
  },
  {
    ...
    childPaths: [
      ...
      { path: "/instances", permission: "accounts" },
